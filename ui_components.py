...
class ImageWidget(Static):
    ...
    class ReplyRequested(Message):
        ...
        def __init__(
            ...
            self.attachment_id = attachment_id
            # True when ``text`` is the synthesized typed placeholder
    ...
    def __init__(
        ...
        *,
        ...
        caption:
            ...
            in the reply text.
        attachment_info:
            Raw attachment detail (filename/label), carried on the reply event.
        protocol:
    ...
    def _make_reply_requested(self) -> "ImageWidget.ReplyRequested":
        ...
        return self.ReplyRequested(
            ...
            message_id=self._message_id,
            attachment_info=self._attachment_info,
