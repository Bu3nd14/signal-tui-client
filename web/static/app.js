...
function openThread(contact) {
  ...
  elements.threadMeta.innerHTML = `${protocolIcon(contact.protocol)}<span class="thread-proto-name">${contact.protocol}</span> · sola lettura`;
