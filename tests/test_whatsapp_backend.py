...
class TestWhatsAppWebhookRegistration:
    ...
    def test_configure_webhook_registers_when_missing(self):
        ...
        assert call_config["config"]["webhooks"][0]["events"] == ["message", "message.any", "message.new", "messages.upsert", "messages/upsert", "message.ack", "message/ack", "message.receipt"]
    ...
    def test_configure_webhook_skips_when_already_registered(self):
        ...
        with patch.object(backend._rest, "get_session_status", return_value={
            "config": {"webhooks": [{"url": webhook, "events": ["message", "message.any", "message.new", "messages.upsert", "messages/upsert", "message.ack", "message/ack", "message.receipt"]}]}
